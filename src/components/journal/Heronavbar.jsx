              ...
              >
                {menu.items.map((item) => (
                  <a
                    key={item.label}
                    href={item.href}
                    className="dropdown-item group flex items-center justify-between px-20 py-3 text-neutral-700 transition-colors duration-150 hover:bg-neutral-900 hover:text-white"
                  >
                    <p>{item.label}</p>
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
