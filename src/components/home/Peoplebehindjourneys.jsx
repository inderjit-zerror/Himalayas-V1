      ...
      <div className="mx-auto ">
        ...
        <div className="flex flex-col gap-12 sm:gap-16 lg:flex-row lg:items-start lg:justify-between">
          <div className="flex w-full justify-center lg:w-1/2 lg:justify-start pt-6 sm:pt-0">
            <div
              className="pbj-polaroid w-full max-w-[280px] sm:max-w-[400px] lg:max-w-[500px] aspect-square -rotate-3 bg-[#fdfdfc] p-3 pb-16 sm:p-4 sm:pb-20 shadow-[0_10px_40px_-15px_rgba(0,0,0,0.15)] border border-neutral-100"
              style={{ transformOrigin: "center" }}
            >
              <img
                src="/img/12.jpg"
