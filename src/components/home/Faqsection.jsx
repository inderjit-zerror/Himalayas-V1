...
//               className="whitespace-nowrap border border-neutral-800 bg-white px-5 py-2.5 text-sm font-semibold text-neutral-900 transition-colors hover:bg-neutral-900 hover:text-white disabled:opacity-60"
//             >
//               {status === "submitting"
//                 ? "Subscribing..."
//                 : status === "success"
        ...
        <div className="mt-10 flex flex-col sm:flex-row justify-end w-full">
          ...
          >
            ...
            <button
              type="submit"
              disabled={status === "submitting"}
              className="whitespace-nowrap border border-neutral-800 bg-white px-5 py-3 sm:py-2.5 btn-text text-neutral-900 transition-colors hover:bg-neutral-900 hover:text-white disabled:opacity-60"
            >
              {status === "submitting"
                ? "Subscribing..."
                : status === "success"
