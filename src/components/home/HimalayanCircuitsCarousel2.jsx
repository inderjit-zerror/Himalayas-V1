...
export default function HimalayanCircuitsCarousel2() {
  ...
  return (
    <section className="w-full bg-white pl-4 py-10 sm:py-24 md:pl-20 overflow-x-hidden">
      <div className="mx-auto w-full">
        ...
        {/* Footer row */}
        <div className="mt-5 sm:mt-14 flex flex-col items-start justify-between gap-6 pr-10 md:flex-row md:items-center max-sm:pr-5">
