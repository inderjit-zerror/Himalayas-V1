...
//                     >
//                       <div
//                         className={`group flex items-center justify-between border-b border-neutral-200 py-3 text-2xl transition-colors sm:text-3xl ${
//                           isActive
...
//                         {isJourneys && (
//                           <span
//                             className={`hidden lg:flex items-center scale-[2] justify-center text-xl font-light text-neutral-600 transition-transform duration-300 ml-4 ${
//                               isJourneysHovered ? "rotate-45" : "rotate-0"
//                             }`}
//                             aria-hidden="true"
//                           >
//                             +
            ...
            return (
              <li key={link.href}>
                <Link
                  href={link.href}
                  className={`relative py-1 transition-colors hover:text-neutral-500 ${
                    isActive ? "border-b-2 border-neutral-900 font-semibold text-neutral-900" : ""
                  }`}
                >
                  {link.label}
                </Link>
                  ...
                  return (
                    ...
                    >
                      ...
                      >
                        ...
                        {isJourneys && (
                          <span
                            className={`hidden lg:flex items-center scale-[2] justify-center text-xl font-light text-black transition-transform duration-300 ml-4 ${
                              isJourneysHovered ? "rotate-45" : "rotate-0"
                            }`}
                            aria-hidden="true"
                          >
